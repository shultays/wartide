...
; explosion_x -= 8;
;
L06AE:	lda     _explosion_x
	sec
	sbc     #$08
L11E4:	sta     _explosion_x
;
; building_index_y = 17;
;
	lda     #$11
...
; --craft_bullet_timers[i];
;
L1082:	lda     #<(_craft_bullet_timers)
	ldx     #>(_craft_bullet_timers)
	clc
	adc     _i
	bcc     L10A7
