...
;
L0965:	lda     _dont_change_bg_pallette
	beq     L0968
...
;
	jmp     L108E
L0984:	lda     _dont_change_bg_pallette
	bne     L0989
	lda     _temp0
	cmp     #$1D
	beq     L0989
...
; craft_bullet_timers[i]--;
;
L0EEB:	lda     #<(_craft_bullet_timers)
	ldx     #>(_craft_bullet_timers)
	clc
	adc     _i
	bcc     L0F10
